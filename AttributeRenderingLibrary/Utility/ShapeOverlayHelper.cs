...
public class ShapeOverlayHelper
{
    ...
    public static void BakeVariantTextures(ICoreClientAPI clientApi, UniversalShapeTextureSource textureSource, Variants variants, VariantSelectionList<Dictionary<string, CompositeTexture>> texturesByType, Dictionary<string, AssetLocation> prefixedTextureCodes = null, string overlayPrefix = "")
    {
        if (!texturesByType.FindFirstByVariant(variants, out Dictionary<string, CompositeTexture> variantTextures)) return;
