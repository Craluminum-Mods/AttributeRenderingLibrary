...
namespace AttributeRenderingLibrary.Systems.Creativestacks;

public class VariantLoader : ModSystem
{
#nullable disable
...
#nullable enable
    ...
    public override void AssetsFinalize(ICoreAPI api)
    {
        ...
        CollectCollectibleObjectsToGenerate();
        CollectVariantsFromWorldProperties();
        ComposeVariants();
    }
